...
type 'a pre_MethodPrototype =
  ...
  [@@deriving sexp,show,yojson]
type coq_MethodPrototype = (Info.t * Types.Annotation.t list) pre_MethodPrototype
  [@@deriving sexp,show,yojson]
...
and 'a pre_Expression =
  [%import:'a Poulet4.Syntax.coq_Expression
    [@with coq_ExpressionPreT := pre_ExpressionPreT;
      ...
      Poulet4.Typed.coq_P4Type := T.pre_P4Type]]
  [@@deriving sexp,show,yojson]
type coq_KeyValue = (Info.t * Types.Annotation.t list) pre_KeyValue
  [@@deriving sexp,show,yojson]
type coq_ExpressionPreT = (Info.t * Types.Annotation.t list) pre_ExpressionPreT
  [@@deriving sexp,show,yojson]
type coq_Expression = (Info.t * Types.Annotation.t list) pre_Expression
  [@@deriving sexp,show,yojson]
...
type coq_ValueLvalue = (Info.t * Types.Annotation.t list) pre_ValueLvalue
  [@@deriving sexp,show,yojson]
type coq_ValueFunctionImplementation = (Info.t * Types.Annotation.t list) pre_ValueFunctionImplementation
  [@@deriving sexp,show,yojson]
