  ...
  module rec Expression : sig
    ...
    let rec format_t fmt e =
     ...
     and Argument : sig
       ...
       let format_t fmt e = format_pre_t fmt (snd e)
     ...
     and Declaration : sig
       ...
       val format_field : Format.formatter -> P4.Declaration.field -> unit
     end = struct
       open P4.Declaration
...
module Typed = struct
  let format_coq_P4Type fmt t =
    failwith "unimplemented"

  let format_coq_P4Parameter fmt p =
    failwith "unimplemented"
