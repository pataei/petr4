...
type coq_FunctionType = Types.tag Poulet4.Typed.coq_FunctionType
type coq_ControlType = Types.tag Poulet4.Typed.coq_ControlType
type coq_P4Parameter = Types.tag Poulet4.Typed.coq_P4Parameter
type coq_StmtContext = Types.tag Poulet4.Typed.coq_StmtContext
type coq_DeclContext = Types.tag Poulet4.Typed.coq_DeclContext
